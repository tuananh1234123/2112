...
<link rel="stylesheet" type="text/css" href="<c:url value='/template/web/styles/cart_styles.css'/>
">
<link rel="stylesheet" type="text/css" href="<c:url value='/template/web/styles/cart_responsive.css'/>">
</head>
