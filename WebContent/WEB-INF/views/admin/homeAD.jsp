			...
			<div class="col-md-4 stretch-card grid-margin">
				<div class="card bg-gradient-danger card-img-holder text-white">
					<div class="card-body">
						<img
							src="
									     <c:url value='/template/admin/images/dashboard/circle.svg'/>
							"
				...
				<div class="card">
					<div class="card-body">
						...
						<canvas id="visit-sale-chart" class="mt-4 chartjs-render-monitor"
							style="display: block; height: 162px; width: 325px;" width="487"
							height="243"></canvas>
					</div>
				</div>
			</div>
			<div class="col-md-5 grid-margin stretch-card">
				<div class="card">
					<div class="card-body">
						...
						<canvas id="traffic-chart" width="487" height="243"
							class="chartjs-render-monitor"
							style="display: block; height: 162px; width: 325px;"></canvas>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										<td><img
											src="
													   <c:url value='/template/admin/images/faces/face2.jpg'/>
													"
									...
									<tr>
										<td><img
											src=" <c:url value='/template/admin/images/faces/face3.jpg'/>"
									...
									<tr>
										<td><img
											src=" <c:url value='/template/admin/images/faces/face4.jpg'/>"
					...
					<div class="card-body">
						...
						<div class="row mt-3">
							<div class="col-6 pr-1">
								<img
									src="
											 <c:url value='/template/admin/images/dashboard/img_1.jpg'/>
											"
									class="mb-2 mw-100 w-100 rounded" alt="image"> <img
									src="
												<c:url value='/template/admin/images/dashboard/img_4.jpg'/>
												"
									class="mw-100 w-100 rounded" alt="image">
							</div>
							<div class="col-6 pl-1">
								<img
									src="<c:url value='/template/admin/images/dashboard/img_2.jpg'/>"
									class="mb-2 mw-100 w-100 rounded" alt="image"> <img
									src="<c:url value='/template/admin/images/dashboard/img_3.jpg'/>"
									class="mw-100 w-100 rounded" alt="image">
							</div>
						</div>
						<div class="d-flex mt-5 align-items-top">
							<img
								src="
										<c:url value='/template/admin/images/faces/face3.jpg'/>
										"
