				...
				<ul class="nav">
					<li class="nav-item nav-profile"><a href="#" class="nav-link">
							...
							<div class="nav-profile-text d-flex flex-column">
								<span class="font-weight-bold mb-2">${sessionScope.Staff.getStaffName()}</span> <span
					...
					<li class="nav-item"><a class="nav-link"
						href="homeAdmin/employe.php"
					> <span class="menu-title">Manage Employe</span> <i class="menu-arrow"></i> <i
					...
					<li class="nav-item"><a class="nav-link"
						href="homeAdmin/product.php"> <span class="menu-title">Manage Product</span>
							<i class="mdi mdi-contacts menu-icon"></i>
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="homeAdmin/shipper.php"> <span
